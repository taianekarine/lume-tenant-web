...
import { getSentQuoteProposalsForDashboard } from '@/features/quote-proposals/server';
import {
...
export const metadata: Metadata = {
  title: 'Orçamentos enviados | Lume',
  description: 'Orçamentos enviados que aguardam decisão.',
};
...
export default async function Page() {
  ...
  try {
    proposals = (await getSentQuoteProposalsForDashboard()).items;
  } catch (error) {
    ...
    initialError =
      error instanceof QuoteProposalRepositoryError
        ? error.message
        : 'Não foi possível carregar os orçamentos enviados da Tenant API.';
  }
